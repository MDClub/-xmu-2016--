        ...
        private void btBookInfo_Click(object sender, EventArgs e)
        {
            ...
            if (sqlstr != "")
            {
                ...
                if (cBooks.Count > 0)
                {
                    ...
                    this.dgvSearchResult.Columns["bookID"].HeaderText = "客房编号";
                    this.dgvSearchResult.Columns["bookSortID"].HeaderText = "客房类型编号";
                    this.dgvSearchResult.Columns["bookName"].HeaderText = "客房名称";
                    this.dgvSearchResult.Columns["bookAutor"].HeaderText = "客房风格";
                    this.dgvSearchResult.Columns["bookPublish"].HeaderText = "客房计价周期";
                    this.dgvSearchResult.Columns["bookPubDate"].HeaderText = "投用日期";
                    this.dgvSearchResult.Columns["bookPrice"].HeaderText = "定价";
                    this.dgvSearchResult.Columns["bookSummary"].HeaderText = "客房介绍";
                    this.dgvSearchResult.Columns["bookRealNum"].HeaderText = "实际数量";
                    this.dgvSearchResult.Columns["bookLendNum"].HeaderText = "入住数量";
                    this.dgvSearchResult.Columns["bookResDate"].HeaderText = "客房登记日期";
                }
                else
                {
        ...
        private void btReader_Click(object sender, EventArgs e)
        {
            ...
            if (sqlStr != "")
            {
                ...
                if (cReaders.Count > 0)
                {
                    ...
                    this.dgvSearchResult.Columns["readerID"].HeaderText = "客户编号";
                    this.dgvSearchResult.Columns["readerName"].HeaderText = "客户姓名";
                    this.dgvSearchResult.Columns["readerSex"].HeaderText = "性别";
                    this.dgvSearchResult.Columns["readerOffice"].HeaderText = "客户职务";
                    this.dgvSearchResult.Columns["readerDept"].HeaderText = "身份证号";
        ...
        private void btLend_Click(object sender, EventArgs e)
        {
            ...
            if (StrSQL != "")
            {
                ...
                if (cLends.Count > 0)
                {
                    ...
                    this.dgvSearchResult.Columns["bookID"].HeaderText = "客房编号";
                    this.dgvSearchResult.Columns["readerID"].HeaderText = "客户编号";
                    this.dgvSearchResult.Columns["lendNum"].HeaderText = "入住数量";
                    this.dgvSearchResult.Columns["lendDate"].HeaderText = "入住日期";
                    this.dgvSearchResult.Columns["lendYDate"].HeaderText = "应退房日期";
                    this.dgvSearchResult.Columns["lendSDate"].HeaderText = "实归还日期";
                    this.dgvSearchResult.Columns["lendMulct"].HeaderText = "应付金额";
                }
                else
                {
                    MessageBox.Show("未查到相关信息！", "操作提示");
