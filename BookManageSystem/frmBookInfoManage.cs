...
namespace BookManageSystem
{
    public partial class frmBookInfoManage : Form
    {
        ...
        private void RefreshAllInfo()
        {
            ...
            this.dgvAllBookInfo.Columns["bookID"].HeaderText = "客房编号";
            this.dgvAllBookInfo.Columns["bookSortID"].HeaderText = "客房类型编号";
            this.dgvAllBookInfo.Columns["bookName"].HeaderText = "客房名称";
            this.dgvAllBookInfo.Columns["bookAutor"].HeaderText = "客房风格";
            this.dgvAllBookInfo.Columns["bookPublish"].HeaderText = "客房计价周期";
            this.dgvAllBookInfo.Columns["bookPubDate"].HeaderText = "投用日期";
            this.dgvAllBookInfo.Columns["bookPrice"].HeaderText = "定价";
            this.dgvAllBookInfo.Columns["bookSummary"].HeaderText = "客房介绍";
            this.dgvAllBookInfo.Columns["bookRealNum"].HeaderText = "实际数量";
            this.dgvAllBookInfo.Columns["bookLendNum"].HeaderText = "入住数量";
            this.dgvAllBookInfo.Columns["bookResDate"].HeaderText = "客房登记日期";
        ...
        private void tsbDeleteInfo_Click(object sender, EventArgs e)
        {
            ...
            if (dgvAllBookInfo.CurrentRow != null)
            {
                ...
                if (MessageBox.Show("删除编号为" + bookID.ToString() + "的客房会删除所有与此客房关联的入住与还客房信息,确定要删除吗？", "操作提示", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
