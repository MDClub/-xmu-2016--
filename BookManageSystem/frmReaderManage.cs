...
namespace BookManageSystem
{
    public partial class frmReaderManage : Form
    {
        ...
        private void RefreshAllReader()
        {
            ...
            this.dgvAllReader.Columns["readerID"].HeaderText = "客户编号";
            this.dgvAllReader.Columns["readerName"].HeaderText = "客户姓名";
            this.dgvAllReader.Columns["readerSex"].HeaderText = "客户性别";
            this.dgvAllReader.Columns["readerOffice"].HeaderText = "客户职务";
            this.dgvAllReader.Columns["readerDept"].HeaderText = "身份证号";
        ...
        private void tsbDeleteReader_Click(object sender, EventArgs e)
        {
            ...
            if (dgvAllReader.CurrentRow != null)
            {
                ...
                if (MessageBox.Show("删除编号为" + readerID.ToString() + "的客户会删除所有与此客户关联的入住与还客房信息,确定要删除吗？", "操作提示", MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
