...
namespace BookManageSystem
{
    ...
    {
        private bool btBookInfo=false;//是否具有客房管理权限
        private bool btReader = false;//是否具有客户维护权限
        private bool btLend = false;//是否具有入住管理权限
