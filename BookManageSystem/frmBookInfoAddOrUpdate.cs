                                            ...
                                            if (tbBookRealNum.Text != "")
                                                if (tbLendNum.Text != "")
                                                    if (rtbBookSummary.Text != "")
                                                    {
                                                        ...
                                                        MessageBox.Show("客房摘要不能为空！", "操作提示");
                                                else
                                                    MessageBox.Show("入住数量不能为空！", "操作提示");
                                            else
                                                MessageBox.Show("实际数量不能为空！", "操作提示");
                                        else
                                            MessageBox.Show("定价不能为空！", "操作提示");
                                    else
                                        MessageBox.Show("计价周期不能为空！", "操作提示");
                                else
                                    MessageBox.Show("风格不能为空！", "操作提示");
                            else
                                MessageBox.Show("客房名称不能为空！", "操作提示");
                        else
                            MessageBox.Show("客房类别不能为空！", "操作提示");
                    else
                        MessageBox.Show("客房编号不能为空！", "操作提示");
                }
                catch (Exception ex)
                {
